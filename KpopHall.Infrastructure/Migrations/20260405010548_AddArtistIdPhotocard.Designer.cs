...
namespace KpopHall.Infrastructure.Migrations
{
    ...
    [Migration("20260405010548_AddArtistIdPhotocard")]
    partial class AddArtistIdPhotocard
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KpopHall.Domain.Entities.Photocard", b =>
                {
                    ...
                    b.Property<string>("BacksideImagePath")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("FrontsideImagePath")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("KpopHall.Domain.Entities.RefreshToken", b =>
                {
                    b.HasOne("KpopHall.Domain.Entities.User", "User")
